...
```go
import (
	"github.com/m3ter-com/m3ter-sdk-go" // imported as m3ter
)
```
...
```sh
go get -u 'github.com/m3ter-com/m3ter-sdk-go@v0.1.0-alpha.10'
```
...
params := FooParams{
	...
	Description: m3ter.Null[string](),

	Point: m3ter.F(m3ter.Point{
		X: m3ter.Int(0),
		Y: m3ter.Int(1),

		// In cases where the API specifies a given type,
		// but you want to send something else, use `Raw`:
		Z: m3ter.Raw[int64](0.01), // sends a float
	}),
}
```
...
See the [full list of request options](https://pkg.go.dev/github.com/m3ter-com/m3ter-sdk-go/option).
...
`*m3ter.Error`. This contains the `StatusCode`, `*http.Request`, and
...
if err != nil {
	...
	panic(err.Error()) // GET "/organizations/{orgId}/products": 400 Bad Request { ... }
}
```
...
We also provide a helper `m3ter.FileParam(reader io.Reader, filename string, contentType string)`
...
params := FooNewParams{
    ID:   m3ter.F("id_xxxx"),
    Data: m3ter.F(FooNewParamsData{
        FirstName: m3ter.F("John"),
    }),
}
...
We are keen for your feedback; please open an [issue](https://www.github.com/m3ter-com/m3ter-sdk-go/issues) with questions, bugs, or suggestions.
