...
// Pricing ID.
func (r *PricingService) List(ctx context.Context, orgID string, query PricingListParams, opts ...option.RequestOption) (res *PricingListResponse, err error) {
	opts = append(r.Options[:], opts...)
	if orgID == "" {
		err = errors.New("missing required orgId parameter")
		return
...
type PricingListResponse = interface{}
