...
type OrganizationConfigRequestParam struct {
	...
	AutoGenerateStatementMode param.Field[OrganizationConfigRequestAutoGenerateStatementMode] `json:"autoGenerateStatementMode"`
	...
	CreditApplicationOrder param.Field[[]OrganizationConfigRequestCreditApplicationOrder] `json:"creditApplicationOrder"`
...
func (r OrganizationConfigRequestParam) MarshalJSON() (data []byte, err error) {
...
// - **JSON**. Statements are auto-generated in JSON format.
// - **JSON and CSV**. Statements are auto-generated in both JSON and CSV formats.
type OrganizationConfigRequestAutoGenerateStatementMode string

const (
	OrganizationConfigRequestAutoGenerateStatementModeNone       OrganizationConfigRequestAutoGenerateStatementMode = "NONE"
	OrganizationConfigRequestAutoGenerateStatementModeJson       OrganizationConfigRequestAutoGenerateStatementMode = "JSON"
	OrganizationConfigRequestAutoGenerateStatementModeJsonAndCsv OrganizationConfigRequestAutoGenerateStatementMode = "JSON_AND_CSV"
)

func (r OrganizationConfigRequestAutoGenerateStatementMode) IsKnown() bool {
	switch r {
	case OrganizationConfigRequestAutoGenerateStatementModeNone, OrganizationConfigRequestAutoGenerateStatementModeJson, OrganizationConfigRequestAutoGenerateStatementModeJsonAndCsv:
		return true
	}
	return false
}

type OrganizationConfigRequestCreditApplicationOrder string

const (
	OrganizationConfigRequestCreditApplicationOrderPrepayment OrganizationConfigRequestCreditApplicationOrder = "PREPAYMENT"
	OrganizationConfigRequestCreditApplicationOrderBalance    OrganizationConfigRequestCreditApplicationOrder = "BALANCE"
)

func (r OrganizationConfigRequestCreditApplicationOrder) IsKnown() bool {
	switch r {
	case OrganizationConfigRequestCreditApplicationOrderPrepayment, OrganizationConfigRequestCreditApplicationOrderBalance:
		return true
	}
	return false
}
...
func (r OrganizationConfigUpdateParams) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r.OrganizationConfigRequest)
}
