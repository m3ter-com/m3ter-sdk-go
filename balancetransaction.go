...
type ScheduleRequestParam struct {
	...
	Frequency param.Field[ScheduleRequestFrequency] `json:"frequency,required"`
	...
	// months.
	FrequencyInterval param.Field[int64] `json:"frequencyInterval,required"`
	...
	// Schedule.
	TransactionDescription param.Field[string] `json:"transactionDescription,required"`
	...
	TransactionTypeID param.Field[string] `json:"transactionTypeId,required"`
