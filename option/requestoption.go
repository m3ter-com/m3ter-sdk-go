...
// RequestOption is an option for the requests made by the m3ter API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/m3ter-com/m3ter-sdk-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.m3ter.com/")
}
...
// WithAPISecret returns a RequestOption that sets the client setting "api_secret".
func WithAPISecret(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.APISecret = value
		return nil
	})
